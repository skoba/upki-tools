...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = 'https://github.com/medical-oss/upki-tools'
  spec.license       = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/medical-oss/upki-tools'
  spec.metadata['changelog_uri'] = 'https://github.com/medical-oss/upki-tools/CHANGELOG.md'
